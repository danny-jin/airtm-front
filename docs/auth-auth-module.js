...
const routes = [
    {
        ...
        children: [
            ...
            { path: _core_constants_routes__WEBPACK_IMPORTED_MODULE_2__["ROUTES"].auth.login, loadChildren: () => Promise.all(/*! import() | login-login-module */[__webpack_require__.e("default~complete-profile-complete-profile-module~invite-friends-invite-friends-module~login-login-mo~7b038ed0"), __webpack_require__.e("default~client-client-module~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("default~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("login-login-module")]).then(__webpack_require__.bind(null, /*! ./login/login.module */ "lu3c")).then(m => m.LoginModule) },
            { path: _core_constants_routes__WEBPACK_IMPORTED_MODULE_2__["ROUTES"].auth.signUp, loadChildren: () => Promise.all(/*! import() | signup-signup-module */[__webpack_require__.e("default~complete-profile-complete-profile-module~invite-friends-invite-friends-module~login-login-mo~7b038ed0"), __webpack_require__.e("default~client-client-module~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("default~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("default~complete-profile-complete-profile-module~signup-signup-module"), __webpack_require__.e("signup-signup-module")]).then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "0X9z")).then(m => m.SignupModule) },
            {
                path: _core_constants_routes__WEBPACK_IMPORTED_MODULE_2__["ROUTES"].auth.completeProfile,
                loadChildren: () => Promise.all(/*! import() | complete-profile-complete-profile-module */[__webpack_require__.e("default~complete-profile-complete-profile-module~invite-friends-invite-friends-module~login-login-mo~7b038ed0"), __webpack_require__.e("default~client-client-module~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("default~complete-profile-complete-profile-module~login-login-module~signup-signup-module"), __webpack_require__.e("default~complete-profile-complete-profile-module~signup-signup-module"), __webpack_require__.e("complete-profile-complete-profile-module")]).then(__webpack_require__.bind(null, /*! ./complete-profile/complete-profile.module */ "uDca")).then(m => m.CompleteProfileModule)
            }
        ]
    }
];
