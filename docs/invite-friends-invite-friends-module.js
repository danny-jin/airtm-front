...
InviteFriendsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineComponent"]({ type: InviteFriendsComponent, selectors: [["app-invite-friends"]], decls: 66, vars: 61, consts: [[1, "container"], [1, "text-dark", "text-center", "mb-15"], [1, "d-flex", "mb-10"], [1, "text-dark", "font-weight-bold"], [1, "text-primary", "text-decoration-none", "font-weight-bold"], [1, "d-flex", "justify-content-center", "mb-40"], [1, "btn", "btn-primary", "rounded-pill", "width-250"], [1, "row", "justify-content-center", "mb-30"], [1, "col-12", "col-sm-3", "mb-20"], ["defaultImage", "assets/images/placeholder.png", "lazyLoad", "assets/images/client-pages/invite-friends/invite-friends.svg", "alt", "Invite Friends", "loading", "lazy", 1, "w-100"], [1, "col-12", "col-sm-9"], [1, "text-dark", "mb-15"], [1, "w-100", 3, "formGroup"], ["formControlName", "emails", 3, "placeholder"], ["class", "d-flex flex-column", 4, "ngIf", "ngIfElse"], ["hasEmails", ""], [1, "d-flex", "mt-30"], [1, "text-info"], [1, "d-flex", "flex-column", "p-20", "elevation-1"], [1, "text-primary"], [1, "text-info", "mb-5"], [1, "d-flex", "flex-column"], [1, "text-info", "mb-10"], ["formControlName", "referralLink", 3, "hasCopyLink", "readonly", "copyLink"], [1, "d-flex"], [1, "btn", "btn-facebook", "width-150", "rounded-pill", "me-20"], ["icon", "facebook", "color", "white", 3, "width"], [1, "btn", "btn-whatsapp", "width-150", "rounded-pill", "me-20"], ["icon", "whatsapp", "color", "white", 3, "width"], [1, "ms-5"], [1, "text-dark", "mb-10"], [1, "d-flex", "flex-column", "mb-5"], ["class", "text-info mb-5", 4, "ngFor", "ngForOf"], [1, "btn", "btn-primary", "rounded-pill", "width-100"]], template: function InviteFriendsComponent_Template(rf, ctx) { if (rf & 1) {
